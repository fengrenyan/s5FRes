Introduction: 
This prototype, which is used to compute the result R of forgetting some set V of atoms from a give S5 formula F, is implemented in Prolog.   
 

 How to run this prototype?

 If you want to compute forgetting results, you need to input a set V of atoms and a formula F after opening the source code with SWI-prolog.
 Besides, the atoms appearing in F should be transformed into a proposition using predicts ``gain_prop/2" and ``add_propTerm/1".
